        ...
        <div className="p-6">
          <DialogHeader className="mb-5">
            <DialogTitle className="text-lg">
              {mode === 'signin' ? 'Sign in to Workpaste' : 'Create your account'}
            </DialogTitle>
            <p className="text-sm text-muted-foreground mt-1">
              Your data syncs across all devices when signed in.
            </p>
          </DialogHeader>
          ...
          <div className="space-y-3">
            ...
            <Button className="w-full" onClick={handleEmailAuth} disabled={loading || !email || !password}>
          ...
          <p className="mt-4 text-center text-xs text-muted-foreground">
            ...
            <button
              ...
              className="cursor-pointer font-medium text-foreground underline underline-offset-2 hover:opacity-70"
            >
